...
# Febrile Neutropenia {background-color="#b20e10" background-video="images/neutrophil.mp4" background-video-loop="true" background-video-muted="true" background-size="cover" background-opacity="0.3"}
...
![](images/DMM_newlogo.png){fig-align="center" width="350"}
...
::: {style="position: absolute; bottom: 20px; width: 100%; text-align: center; font-size: 0.5em; color: white;"}
<br> Background video: Neutrophil chasing *S. aureus*. <br> Taken by Dr. David Rogers, University of Vanderbuilt
:::
...
|                               | - Peroxidase                                     |                                                 |
+-------------------------------+--------------------------------------------------+-------------------------------------------------+
| **Natural killer (NK) cells** | - Perforins                                      | Viral or bacterial infected cells               |
|                               |                                                  |                                                 |
|                               | - Granzymes                                      |                                                 |
+-------------------------------+--------------------------------------------------+-------------------------------------------------+
...
$$\text{ANC} = \text{WBC} \times \frac{(\%\ \text{segmented neutrophils} + \%\ \text{banded neutrophils})}{100}$$
...
## Risk of infection by disease type
...
## The integument (skin, mucus membranes)
...
::: {.column width="50%"}
![](images/MDR%20pseudomonas.png){width="1400"}
:::
:::::
...
## Which pathogens translocate to the bloodstream?
...
+---------------------+---------------------------------------------------------------+-----------------+------------------------+
| **Port-a-cath**     | ![](images/clipboard-47554115.png){width="200"}               | 3.5-4           | 0.1                    |
+---------------------+---------------------------------------------------------------+-----------------+------------------------+
| **PICC**            | ![](images/PICC.png){width="150"}                             | 3.1             | 1.1                    |
+---------------------+---------------------------------------------------------------+-----------------+------------------------+
...
![](images/gerson.png){fig-align="center" width="1000"}
...
## Novel targeted therapies: immune sequelae {.smaller}

+--------------+-----------------------------------------------------+-------------------------------------------------------+-------------------------------------------------------+---------------------------------------------------------------------+-----------------------------------------------------------------------+
| Target       | Agents                                              | B-Cell Depletion                                      | T-Cell Depletion                                      | HGG^1^                                                              | Neutropenia                                                           |
|              |                                                     |                                                       |                                                       |                                                                     |                                                                       |
|              | ![](images/target.png){fig-align="left" width="50"} | ![](images/B-cell.png){fig-align="center" width="50"} | ![](images/T-cell.png){fig-align="center" width="50"} | ![](images/antibody.png){fig-align="center" width="50" height="51"} | ![](images/neutrophil.png){fig-align="center" width="50" height="45"} |
+==============+=====================================================+:=====================================================:+:=====================================================:+:===================================================================:+:=====================================================================:+
|              | Rituximab                                           | +++                                                   | \-                                                    | \+                                                                  | ++^2^                                                                 |
+--------------+-----------------------------------------------------+-------------------------------------------------------+-------------------------------------------------------+---------------------------------------------------------------------+-----------------------------------------------------------------------+
| **CD20**     | Ofatumumab                                          | +++                                                   | \-                                                    | \+                                                                  |                                                                       |
...
::: aside
Plus signs indicate relative effect (mild, moderate, significant). ^1^ Hypogammaglobulinemia. ^2^ Late neutropenia may occur (median time 175 days, Dunleavy et al.). ^3^ Neutropenia typically resolves in 2–4 weeks [@little2021].
:::
...
![](images/cmi_pathogens.png){fig-align="center" width="1000"}

::: aside
*These pathogens **are not** covered by typical empiric regimens used for febrile neutropenia!*
:::

# Summary-Key infection epidemiology {background-color="#b20e10"}
...
::: notes
This shift is accompanied by increasing antimicrobial resistance, making empirical therapy selection more challenging [@Averbuch2013].
:::
...
- *Aspergillus* species \> *Candida* in hematology due to fluconazole prophylaxis that covers yeast but not molds
...
- Herpes simplex 1&2 (HHV 1&2) reactivation: reactivation in up to 60% of seropositive patients with mucositis, profound neutropenia, impaired T-cell function, or high-dose corticosteroid exposure
...
**Fluoroquinolone (ciprofloxacin, levofloxacin) prophylaxis:**
...
- Anticipated IFD incidence in population of \>8%
...
+----------------------+---------------------------------------------------------+--------------------------------------------------------+
| Posaconazole tablets | 300 mg BID day 1, <br>then 300 mg daily \| AML/MDS/ BMT | Candida and molds                                      |
+----------------------+---------------------------------------------------------+--------------------------------------------------------+
...
However, G-CSF vs fluoroquinolone studies show antibiotics may be equally or more effective for preventing febrile neutropenia.
:::
...
- Blood cultures × 2 sets <br> (peripheral + each CVC lumen)
...
- β-D-glucan if invasive fungal disease suspected
...
::: aside
Blood cultures should be drawn **before** antibiotic administration whenever possible, but must not delay empiric therapy.
:::
...
+================================+===========================================================================+
| Respiratory symptoms / hypoxia | Computed tomography (CT)of chest; BAL if stable (GM, cultures, PCR panel) |
+--------------------------------+---------------------------------------------------------------------------+
...
::: aside
Diagnostic yield is limited (positive cultures in \~20–30% of episodes), but targeted workup guides de-escalation and avoids unnecessary broad-spectrum exposure.
:::
...
**Trigger for starting empirical antibiotics:**
...
- Change to anti-pseudomonal carbapenem if septic
- Some clinicians may just add aminoglycoside (I do not personally favor this strategy)
...
- Start antifungal after 4-7 days persistent fever
  - Rationale: INnthe past, up to one-third of patients with prolonged neutropenia had evidence of fungal infections at autopsy- not diagnosed antemortem
...
# Specific clinical infections {background-color="#b20e10"}

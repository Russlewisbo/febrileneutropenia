...
+=========================================+====================================================+=================================================+
| **Polymorphonuclear leukocytes (PMNs)** | -   Lysozyme, myeloperoxidase with (with H~2~O~2)~ | Bacteria, fung                                  |
|                                         |                                                    |                                                 |
| -   1° granules                         | -   Defensins, BPI, lactoferrin                    |                                                 |
|                                         |                                                    |                                                 |
| -   Specific granules                   |                                                    |                                                 |
+-----------------------------------------+----------------------------------------------------+-------------------------------------------------+
...
+---------------------+--------------------------------------------------------------+------------------------+
| Catheter Type       |                                                              | Per 1000 catheter-days |
+=====================+==============================================================+========================+
| Hickman/Broviac     | ![](images/Screenshot%202026-02-06%20174909.png){width="83"} | 1.6                    |
+---------------------+--------------------------------------------------------------+------------------------+
| Port-a-cath         | ![](images/broviac.png){width="100" height="100"}            | 0.1                    |
+---------------------+--------------------------------------------------------------+------------------------+
| PICC                | ![](images/PICC.png){width="154"}                            | 1.1                    |
+---------------------+--------------------------------------------------------------+------------------------+
